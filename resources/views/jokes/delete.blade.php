    ...
    <section class="py-12 mx-12 space-y-4">
        ...
        <form class="flex flex-col gap-4" method="post" action="{{ route('admin.jokes.destroy', $joke) }}">
            ...
            <div class="my-6 bg-gray-200 text-red-500 rounded-lg font-semibold flex flex-row overflow-hidden">
                <p class="overflow-hidden p-6 bg-black"><i class="fa-solid fa-warning text-amber-500 text-7xl"></i></p>

                <div class="grow ml-6 p-6">
                    <h3 class="pb-4 text-2xl">
                        {{ __('Warning! Deleting joke') }} - {{ $joke->title }}
                    </h3>
            ...
            <div class="flex flex-row justify-start">
                ...
                <x-secondary-button type="submit" class="mr-6 text-red-600">
                    <i class="fa-solid fa-delete-left pr-2 text-lg"></i> Confirm
                </x-secondary-button>
            </div>
